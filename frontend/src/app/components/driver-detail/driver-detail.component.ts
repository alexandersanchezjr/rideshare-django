...
import { Trip, Status, TripDataMessage } from '@models/trip';
...
export class DriverDetailComponent {
  ...
  updateTripStatus(status: string): void {
    ...
    this.messageTrip = {
      ...
      pick_up_address: this.trip.pickUpAddress,
      drop_off_address: this.trip.dropOffAddress,
      driver: this.auth.user!.id!,
    };
    this.tripService.updateTrip(this.messageTrip);
  }
}
